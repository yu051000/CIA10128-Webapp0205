...
//            Integer rCatNo = Integer.valueOf(req.getParameter("rCatNo").trim());
            ...
            if (!errorMsgs.isEmpty()) {
                ...
                // ------------------ 2.開始修改資料 ------------------ //
                RentalCategory RentalCategory = rentalCategoryServiceImpl.updateRentalCat(rCatNo, rCatName, rStockQty, rRentedQty, rDesPrice);
...
//            BigDecimal rDesPrice = new BigDecimal(req.getParameter("rDesPrice"));
            ...
            // ------------------ 2.開始查詢資料 ------------------ //
            RentalCategory RentalCategory = rentalCategoryServiceImpl.getOneRentalCat(rCatNo);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// getAllRentalCats
        ...
        private String getAllRentalCats(HttpServletRequest req, HttpServletResponse res) {
            ...
            List<RentalCategory> rentalCatList = rentalCategoryServiceImpl.getAllRentalCats(currentPage); //呼叫ServiceImpl的檢索租借分類列表
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// getByCompositeQuery
        ...
        private String getByCompositeQuery(HttpServletRequest req, HttpServletResponse                                                                                                           res) {
            ...
            if (map != null) {
                ...
                List<RentalCategory> list = rentalCategoryServiceImpl.getByCompositeQuery(map);
